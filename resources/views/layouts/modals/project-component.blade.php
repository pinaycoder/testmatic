<div class="modal inmodal form-horizontal" id="add-project-component-modal" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content animated bounceInRight">
        <form action="/projects/components/create/{{ $project->id }}" method="post" class="form-horizontal" id="add-project-component-form">
                {{ csrf_field() }} 
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" id="add-project-component-row-btn" class="btn btn-primary">Add</button>
                </div>
            </form>
        </div>
    </div>
